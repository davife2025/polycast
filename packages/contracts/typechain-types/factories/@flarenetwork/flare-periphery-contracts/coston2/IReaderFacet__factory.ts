...
import type {
  IReaderFacet,
  IReaderFacetInterface,
} from "../../../../@flarenetwork/flare-periphery-contracts/coston2/IReaderFacet";
...
export class IReaderFacet__factory {
  static readonly abi = _abi;
  static createInterface(): IReaderFacetInterface {
    return new Interface(_abi) as IReaderFacetInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IReaderFacet {
    return new Contract(address, _abi, runner) as unknown as IReaderFacet;
  }
}
