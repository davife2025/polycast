...
import type {
  ...
  IMemoInstructionsFacetInterface,
} from "../../../../@flarenetwork/flare-periphery-contracts/coston2/IMemoInstructionsFacet";
...
export class IMemoInstructionsFacet__factory {
  static readonly abi = _abi;
  static createInterface(): IMemoInstructionsFacetInterface {
    return new Interface(_abi) as IMemoInstructionsFacetInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IMemoInstructionsFacet;
  }
}
