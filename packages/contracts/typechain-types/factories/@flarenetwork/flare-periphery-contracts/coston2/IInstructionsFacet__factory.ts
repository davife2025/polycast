...
import type {
  IInstructionsFacet,
  IInstructionsFacetInterface,
} from "../../../../@flarenetwork/flare-periphery-contracts/coston2/IInstructionsFacet";
...
export class IInstructionsFacet__factory {
  static readonly abi = _abi;
  static createInterface(): IInstructionsFacetInterface {
    return new Interface(_abi) as IInstructionsFacetInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IInstructionsFacet {
    return new Contract(address, _abi, runner) as unknown as IInstructionsFacet;
  }
}
